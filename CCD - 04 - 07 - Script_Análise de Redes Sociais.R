...
#Antes de executar, criar as redes executando o script CCD - 04 - 05 - Script_Análise de Redes Sociais
...
par(mfrow=c(1,2)) #graficos lado a lado
plot(net, vertex.size=hs*50, main="Hubs")
plot(net, vertex.size=as*30, main="Authorities")

#########################################################################
#Cálculo das Métricas relativas ás Estrutura do Grafo
#Proporção de arestas com a caracterrística de reciprocidade
dyad_census(net) #Quantidade de arestas mútuas, assimétricas ou nulas
2*dyad_census(net)$mut/ecount(net) #Cáculo de Reciprocidade
...
# Alterar a cor dos nós, de acordo com a distãncia
