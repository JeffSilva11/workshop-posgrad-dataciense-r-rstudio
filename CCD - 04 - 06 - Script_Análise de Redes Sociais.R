...
#########################################################################
#Definindo atributos e adicionando ao próprio objeto iGraph.
# Criar o vetor de cores que será usado para cada tipo de média:
...
# Alterar o tamanho do nós com base no seu peso
