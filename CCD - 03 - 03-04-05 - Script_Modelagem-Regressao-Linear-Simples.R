...
#Previsão para clock=500
performance = round(51.7871 + 0.5863*500)
performance

#Previsão para clock=500
round(predict(int00.lm, data.frame(clock=500)))

#Cria linha reta no Gráfico de Dispersão
abline(int00.lm) 

#Analise de Correlação - Coeficiente de correlação (-1...1)
cor(int00.dat$clock, int00.dat$perf)
